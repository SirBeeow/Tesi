...
\begin{figure}[htbp] 
    \centering 
    \includegraphics[width=0.5\columnwidth]{verificaApp} 
...
\begin{figure}[htbp] 
    \centering 
    \includegraphics[width=0.5\columnwidth]{githubAppPermessi} 
...
\begin{figure}[htbp] 
    ...
    \caption{Parte dello \emph{script} responsabile per l'ottenimento del \emph{token} di autenticazione Microsoft.}
