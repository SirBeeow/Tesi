...
\begin{itemize}
    ...
    \begin{figure}[htbp] 
        \centering 
        \includegraphics[width=0.6\columnwidth]{lanWan}
...
\noindent Come mostrato nell'immagine, tale processo è iterativo, il che implica che sono ammesse modifiche che possono talvolta compromettere quanto già realizzato. Tuttavia, ciò consente di riallineare il prodotto alle richieste del cliente, grazie ai suoi \emph{feedback}, evitando di divergere dalla sua visione e garantendo un risultato conforme con le aspettative.
...
\begin{figure}[htbp] 
    \centering 
    \includegraphics[width=0.5\columnwidth]{rapportoBU}
